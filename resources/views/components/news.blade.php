            ...
            <div class="relative">
                <picture class="aspect-[960/449]">
                    ...
                    <img src="{{ isset($content->news->image_1) ? asset('storage/images/original/' . $content->news->image_1) : '' }}"
                        alt="New n°1 image" loading="lazy" />
                </picture>
                ...
                <div class="absolute p-11 max-w-[600px] min-w-[600px] -bottom-12 bg-ds-white rounded-3xl left-1/2 -translate-x-1/2 drop-shadow-lg">
                    ...
                    <div class="mt-5">
                        ...
                        <p>{{ isset($content->news->description_1) ? $content->news->description_1 : '' }}</p>
                    </div>
            ...
            <div class="relative">
                ...
                <div class="absolute p-11 max-w-[600px] min-w-[600px] -bottom-12  bg-ds-white rounded-3xl left-1/2 -translate-x-1/2 drop-shadow-lg">
                    ...
                    <div class="mt-5">
                        ...
                        <p>{{ isset($content->news->description_2) ? $content->news->description_2 : '' }}</p>
                    </div>
