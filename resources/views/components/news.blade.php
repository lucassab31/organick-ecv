@if (isset($inIframe) && $inIframe)
    ...
    @section('content')
@endif
    <section class="py-14 w-full flex justify-center">
        <article class="flex flex-col items-center max-w-[1380px]">
            ...
            <div class="flex items-center gap-5 mt-5">
                <div class="relative">
                    ...
                    <div class="absolute p-11 max-w-[600px] min-w-[600px] -bottom-12 bg-ds-white rounded-3xl left-1/2 -translate-x-1/2 drop-shadow-lg">
                        ...
                        <div class="mt-5">
                            <h6 class="text-h6 text-ds-blue">The Benefits of Vitamin D & How to Get It</h6>
                ...
                <div class="relative">
                    <img class="rounded-3xl" src="{{asset('assets/tomate.png')}}" alt="#">
                    <p class="absolute rounded-full bg-ds-white top-3 left-3 w-20 h-20 flex items-center justify-center text-center text-h6 font-extrabold flex-col">
                        31
                    ...
                    <div class="absolute p-11 max-w-[600px] min-w-[600px] -bottom-12  bg-ds-white rounded-3xl left-1/2 -translate-x-1/2 drop-shadow-lg">
                        ...
                        <div class="mt-5">
                            <h6 class="text-h6 text-ds-blue">Our Favourite Summertime Tommeto</h6>
                        <p>Simply dummy text of the printing and typesetting industry. Lorem Ipsum</p>
                        </div>
