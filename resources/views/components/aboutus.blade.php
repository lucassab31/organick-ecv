@if (isset($inIframe) && $inIframe)
    ...
    <section class="container px-5 bg-slate-50 relative flex justify-center w-full p-14">
        <article class="flex items-center max-w-[1390px]">
            <div class="w-1/2">
                <picture loading="lazy">
                    <source
                        srcset="{{ isset($content->about_us->image) ? asset('storage/images/webp/' . pathinfo($content->about_us->image, PATHINFO_FILENAME) . '.webp') : '' }}"
                        type="image/webp">
                    <img src="{{ isset($content->about_us->image) ? asset('storage/images/original/' . $content->about_us->image) : '' }}"
                        alt="Image de la section about us" />
                </picture>
                ...
                <div class="max-w-[700px]">
                    <div>
                        ...
                        <h2 class="text-h2 mb-5 text-ds-blue">
                            {{ isset($content->about_us->title) ? $content->about_us->title : '' }}</h2>
                    ...
                    <div class="mt-10">
                        <div class="flex items-cente gap-5">
                                ...
                                <svg width="101" height="101" viewBox="0 0 101 101" fill="none"
                                    ...
                                    <defs>
                                        <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1"
                                            height="1">
                                            <use xlink:href="#image0_0_557" transform="scale(0.01)" />
                                        </pattern>
                                        <image id="image0_0_557" width="100" height="100"
                            ...
                            <div>
                                <h6 class="text-h6 text-ds-blue">
                                    {{ isset($content->about_us->subtitle_1) ? $content->about_us->subtitle_1 : '' }}</h6>
                                <p>{{ isset($content->about_us->description_1) ? nl2br($content->about_us->description_1) : '' }}
                                </p>
                            </div>
                        </div>
                        <div class="flex items-center mt-7 gap-5">
                            <div>
                                <svg width="101" height="101" viewBox="0 0 101 101" fill="none"
                                    ...
                                    <rect x="19" y="26" width="52" height="52" fill="url(#pattern0)" />
                                    <defs>
                                        <pattern id="pattern0" patternContentUnits="objectBoundingBox" width="1"
                                            height="1">
                                            <use xlink:href="#image0_0_568" transform="scale(0.01)" />
                                        </pattern>
                                        <image id="image0_0_568" width="100" height="100"
                            ...
                            <div>
                                <h6 class="text-h6 text-ds-blue">
                                    {{ isset($content->about_us->subtitle_2) ? $content->about_us->subtitle_2 : '' }}</h6>
                                <p>{{ isset($content->about_us->description_2) ? nl2br($content->about_us->description_2) : '' }}
                                </p>
                            </div>
                        </div>
                    </div>
