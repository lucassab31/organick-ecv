...
@endif
    ...
    <section class="relative flex justify-center w-full p-14">
        <article class="flex items-center max-w-[1390px] gap-9">
            <div>
            <div class="bg-cover bg-center rounded-lg h-[360px] flex items-center pl-16 pr-36"   style="background-image: url('{{ asset("assets/offer1.png") }}')">
                <div class="">
            ...
            <div>
            <div class="bg-cover bg-center rounded-lg h-[360px] flex items-center pl-16 pr-36 "  style="background-image: url('{{ asset("assets/offer2.png") }}')">
                <div>
