...
<div class="relative flex w-full">
    <picture class="aspect-[960/449]" loading="lazy">
        ...
        <img src="{{ (isset($content->hero->image) ? asset('storage/images/original/' . $content->hero->image) : '') }}" alt="Hero banner"/>
    </picture>
    ...
    <div class="absolute top-0 left-0 w-full h-full flex items-center container mx-auto p-5 lg:p-10">
        <div class="max-w-[530px] translate-x-1/2">
            <span class="font-yellowtail text-ds-green text-h4 mb-2">{{ isset($content->hero->subtitle) ? $content->hero->subtitle : '' }}</span>
